...
tape( 'if provided `+infinity` for `x` and finite `mu` and `lambda`, the function returns `0`', opts, function test( t ) {
...
tape( 'if provided a non-positive `mu`, the function always returns `NaN`', opts, function test( t ) {
	var y;
...
tape( 'if provided a non-positive `x`, the function returns `0` (outside support)', opts, function test( t ) {
	var y;
...
tape( 'the function evaluates the pdf for `x` given parameters `mu` and `lambda`', opts, function test( t ) {
	var expected;
	var lambda;
	var mu;
	var x;
